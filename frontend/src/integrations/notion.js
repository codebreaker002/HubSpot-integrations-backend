...
export const NotionIntegration = ({ user, org, integrationParams, setIntegrationParams }) => {
    ...
    const handleConnectClick = async () => {
        try {
            ...
            const response = await axios.post(`https://pg4xskfv-8000.inc1.devtunnels.ms/integrations/notion/authorize`, formData);
    ...
    const handleWindowClosed = async () => {
        try {
            ...
            formData.append('user_id', user);
            formData.append('org_id', org);
            const response = await axios.post(`https://pg4xskfv-8000.inc1.devtunnels.ms/integrations/notion/credentials`, formData);
